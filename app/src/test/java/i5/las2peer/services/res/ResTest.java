...
public class ResTest {
  ...
  /**
   * 
   * Second Test for the POSTJSONPayload_ID337419 method.
   * 
   */
  @Test
  public void testPOSTJSONPayload_ID337419() {
      ...
      ClientResponse result = c.sendRequest("POST", mainPath + "/test", """
{
  "test": 12
      ...
      System.out.println("Result of request with id: 101438: " + result.getResponse().trim());
    
      Assert.assertEquals("[287045]", 200, result.getHttpCode());
  Object response = JSONValue.parse(result.getResponse().trim());
      // Response body has type JSON Object
      assertThat("[985118]", response, isA(JSONObject.class));
